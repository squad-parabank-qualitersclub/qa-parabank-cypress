describe('Validar a criação de um novo usuário', () => {
    it('Criar novo registro no Parabank e validar login após criação', () => {
      ...
      cy.get('#customer\\.firstName').clear('Priscila');
      cy.get('#customer\\.firstName').type('Priscila');
      ...
      cy.get('#customer\\.username').clear('priscila.teste03');
      cy.get('#customer\\.username').type('priscila.teste03');
      cy.get('#customer\\.password').clear('t');
      cy.get('#customer\\.password').type('teste01');
      cy.get('#repeatedPassword').clear();
      cy.get('#repeatedPassword').type('teste01');
